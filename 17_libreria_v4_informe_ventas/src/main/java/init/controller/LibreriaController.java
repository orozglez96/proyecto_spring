...
public class LibreriaController {
	...
	@GetMapping("login")
	public String autenticar(HttpSession sesion, Model model, @RequestParam("cliente") String usuario, 
	...
	public String informe(@RequestParam String fecha1,@RequestParam String fecha2) {
		LocalDateTime ld1=LocalDateTime.of(LocalDateTime.parse(fecha1),LocalTime.now());
		LocalDateTime ld2=LocalDateTime.of(LocalDateTime.parse(fecha2),LocalTime.now());
